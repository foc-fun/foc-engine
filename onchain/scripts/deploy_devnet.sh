...
# echo "cd $CONTRACT_DIR && sncast --accounts-file $DEVNET_ACCOUNT_FILE --account $DEVNET_ACCOUNT_NAME --wait --json deploy --contract-name $FOC_ACCOUNTS_CLASS_NAME --url $RPC_URL --class-hash $FOC_ACCOUNTS_CLASS_HASH --constructor-args $CALLDATA"
