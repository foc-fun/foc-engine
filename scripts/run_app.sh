...
DEFAULT_APP_CONFIG=$APP_PROJECT_PATH/foc-engine.config.json
...
echo "$ONCHAIN_SCRIPTS_DIR/deploy_apps.sh $DEFAULT_APP_CONFIG $APP_PROJECT_PATH $FOC_REGISTRY_CONTRACT_ADDRESS"
$ONCHAIN_SCRIPTS_DIR/deploy_apps.sh $DEFAULT_APP_CONFIG $APP_PROJECT_PATH $FOC_REGISTRY_CONTRACT_ADDRESS

# TODO: Remove .foc_env file
echo
echo "Setting up app environment"
$ONCHAIN_SCRIPTS_DIR/setup_apps.sh $DEFAULT_APP_CONFIG $DEFAULT_APP_SCRIPTS_DIR $FOC_REGISTRY_CONTRACT_ADDRESS .foc_env
